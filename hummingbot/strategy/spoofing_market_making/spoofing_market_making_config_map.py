...
def maker_trading_pair_prompt():
    exchange = spoofing_market_making_config_map.get("exchange").value
...
def validate_max_spread(value: str) -> Optional[str]:
    ...
    if spoofing_market_making_config_map["min_spread"].value is not None:
        min_spread = Decimal(spoofing_market_making_config_map["min_spread"].value)
...
def onvalidated_min_spread(value: str):
    ...
    spoofing_market_making_config_map["max_spread"].value = None


async def order_amount_prompt() -> str:
    exchange = spoofing_market_making_config_map["exchange"].value
    trading_pair = spoofing_market_making_config_map["market"].value
...
def on_validated_price_source_exchange(value: str):
    if value is None:
        spoofing_market_making_config_map["price_source_market"].value = None
...
def on_validated_parameters_based_on_spread(value: str):
    if value == 'True':
        spoofing_market_making_config_map.get("risk_factor").value = None
        spoofing_market_making_config_map.get("order_book_depth_factor").value = None
        spoofing_market_making_config_map.get("order_amount_shape_factor").value = None
    else:
        spoofing_market_making_config_map.get("max_spread").value = None
        spoofing_market_making_config_map.get("min_spread").value = None
        spoofing_market_making_config_map.get("vol_to_spread_multiplier").value = None
        spoofing_market_making_config_map.get("inventory_risk_aversion").value = None


spoofing_market_making_config_map = {
    "strategy":
        ConfigVar(key="strategy",
                  prompt=None,
                  default="spoofing_market_making"),
    "exchange":
    ...
    "parameters_based_on_spread":
        ConfigVar(key="parameters_based_on_spread",
                  prompt="Do you want to automate spoofing-Stoikov parameters based on min/max spread? >>> ",
                  type_str="bool",
                  validator=validate_bool,
    ...
    "min_spread":
        ConfigVar(key="min_spread",
                  ...
                  type_str="decimal",
                  required_if=lambda: spoofing_market_making_config_map.get("parameters_based_on_spread").value,
    ...
    "order_book_depth_factor":
        ConfigVar(key="order_book_depth_factor",
                  ...
                  type_str="decimal",
                  required_if=lambda: not spoofing_market_making_config_map.get("parameters_based_on_spread").value,
