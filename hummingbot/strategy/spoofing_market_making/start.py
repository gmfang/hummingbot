...
from hummingbot.strategy.spoofing_market_making import (
    SpoofingMarketMakingStrategy,
)
from hummingbot.strategy.spoofing_market_making.spoofing_market_making_config_map import spoofing_market_making_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = SpoofingMarketMakingStrategy.OPTION_LOG_ALL
        ...
        self.strategy = SpoofingMarketMakingStrategy(
